...
<?php
	...
	$sql2="SELECT * FROM restaurant_table";
	...
	while($row2 = $result2->fetch_assoc())
	{
		...
		echo "</a>";
			echo "<form action='addrestauranttopackage.php' method='post'><button type='submit' name=restaurant id='restaurant".$total."' value='".$row2['name']."'>Add to Package</button></form>";
